######################################################################
## Custom functions for log-quantile density discrepancy regression ##
######################################################################
## These are helper functions used to perform several conversions on 
## probability density functions.  
## Author: Justin Daniel Strait 2023
