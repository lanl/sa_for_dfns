...
# I'm fairly certain that I want to add in the nugget term here, since a predictive quantity should
# also include the predicted noise at that point in the input space.
