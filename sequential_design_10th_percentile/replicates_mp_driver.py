...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 16 14:28:59 2023
...
new_job_num = int(sys.argv[2])
num_reps    = int(sys.argv[1])
num_of_replications = num_reps
...
def run_job(ijob):
    ...
    # Otherwise, simulate dfnWorks to get an additional BT curve.
        ...
        ##########
        try:
            cmd = f'python3.8 replicates_murph_dfn_v2.py {ijob} {new_job_num}  > outfiles/output_{ijob}.out'
        ...
        # Otherwise, move over the additional files that we want.
            ...
            destination = base_dir + '/compiled_data/output_' + str(ijob) +'/'
            if os.path.exists(location):
                shutil.move(location, destination)
